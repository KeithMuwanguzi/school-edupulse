...
import { FeeStructuresView } from "@/components/domain/finance/FeeStructuresView";
  ...
  if (!roleHasAny(user?.role, ...FINANCE_ROLES)) {
    return (
      <AccessDenied
        ...
        description="Only school administrators and bursars can view fee structures. Contact your school administrator if you need access."
      />
    );
  }
